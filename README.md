...
- Download Files To Input: downloads files (one URL per line) into ComfyUI's `input/` folder (optional subdirectory); optionally provide one filename per line to override output names
